                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                         ...
                         <div className="space-y-6">
                              ...
                              <p className="text-foreground text-lg font-light leading-relaxed">
                                   Quer você tenha um evento de ação, um show, uma corrida ou um projeto em qualquer outra área
                                   da fotografia, posso oferecer expertise técnica e visão criativa. Minha especialidade é capturar
                                   momentos memoráveis com qualidade profissional. Vamos trabalhar juntos para criar imagens
