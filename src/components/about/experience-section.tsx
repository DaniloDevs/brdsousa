     ...
     const experiences = [
          {
               ...
               description: 'Atuo como fotógrafo independente oferecendo serviços em múltiplas categorias. Minha especialidade reside em fotografia de ação — eventos, shows e corridas automotivas — mas trabalho com excelência em retratos, casamentos e lifestyle também.',
               achievements: ['50+ corridas automotivas cobertas', '100+ eventos e shows documentados', 'Expertise em fotografia de ação', 'Cliente focus e qualidade profissional'],
          },
     ];
               ...
               <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-16">
                         ...
                         <p className="text-muted-foreground mt-4 text-lg font-light">
                              Desde 2025, trabalhando com foco em ação e eventos, com versatilidade em todas as áreas
                         </p>
                    </div>
